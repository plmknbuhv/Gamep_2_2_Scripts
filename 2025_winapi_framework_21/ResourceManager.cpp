...
void ResourceManager::RegisterGDI()
{
	...
	m_Pens[(UINT)PenType::GREEN] = ::CreatePen(PS_SOLID, 1, RGB(0, 255, 0));
	 ...
	 // 폰트 등록
	 // 타이틀 폰트: 크기 크게 (논리 높이 음수 = 픽셀 높이), 볼드 적용
	 RegisterFont(FontType::TITLE, L"나눔손글씨 암스테르담", -72, FW_BOLD);
...
{
	LoadSound(L"BGM", L"Sound\\BGM.mp3", true);
	LoadSound(L"TitleBGM", L"Sound\\TitleBGM.mp3", true);
	LoadSound(L"Lightning", L"Sound\\Lightning.mp3", false);
	LoadSound(L"LightningWarring", L"Sound\\LightningWarring.mp3", false);
	LoadSound(L"BossSpawn", L"Sound\\BossSpawn.mp3", false);
	LoadSound(L"BossDash", L"Sound\\BossDash.mp3", false);
	LoadSound(L"LoseSound", L"Sound\\LoseSound\\LoseSound.mp3", false);
	LoadSound(L"LoseBGM", L"Sound\\LoseSound\\LoseBGM.mp3", true);
	LoadSound(L"ClearBGM", L"Sound\\ClearSound\\ClearBGM.mp3", true);
	LoadSound(L"ClearSound", L"Sound\\ClearSound\\ClearSound.mp3", false);
}
...
void ResourceManager::RegisterTexture()
{
	...
	LoadTexture(L"Shadow", L"Texture\\Shadow.bmp");
	LoadTexture(L"playerBulletEffect", L"Texture\\PlayerBulletEffect.bmp");
	LoadTexture(L"playerBullet", L"Texture\\PlayerBullet.bmp");
	LoadTexture(L"meleePlayer", L"Texture\\MeleePlayer.bmp");
	LoadTexture(L"rangedPlayer", L"Texture\\RangedPlayer.bmp");
	LoadTexture(L"BossPage1", L"Texture\\BossPage1.bmp");
	LoadTexture(L"BossPage2", L"Texture\\BossPage2.bmp");
	LoadTexture(L"BlueBullet", L"Texture\\BlueBullet2.bmp");
	LoadTexture(L"RedBullet", L"Texture\\RedBullet.bmp");
	LoadTexture(L"Lightning", L"Texture\\Elect.bmp");
	LoadTexture(L"Warring", L"Texture\\Warring.bmp");
	LoadTexture(L"BabyWalk", L"Texture\\BabyWalk.bmp");

	//UI
	LoadTexture(L"BossHPBackgroundUI", L"Texture\\UI\\BossHp\\BossHPBackgroundUI.bmp");
	LoadTexture(L"BossHPBarUI", L"Texture\\UI\\BossHp\\BossHPBarUI.bmp");
	LoadTexture(L"BossHpHitUI", L"Texture\\UI\\BossHp\\BossHpHitUI.bmp");
	LoadTexture(L"BossHPDesstroyUI", L"Texture\\UI\\BossHp\\BossHPDesstroyUI.bmp");
	LoadTexture(L"BossHPHitedUI", L"Texture\\UI\\BossHp\\BossHPHitedUI.bmp");
	//PlayerDeadUI
	LoadTexture(L"PlayerDeadBackground", L"Texture\\UI\\PlayerDead\\PlayerdeadBack.bmp");
    LoadTexture(L"PlayerDeadBim", L"Texture\\UI\\PlayerDead\\Playerdeadbim.bmp");
    LoadTexture(L"DefeatedText", L"Texture\\UI\\PlayerDead\\DEFEATED_Text.bmp");
	//Button
    LoadTexture(L"ButtonBottom", L"Texture\\UI\\Button\\ButtonBottom.bmp");
    LoadTexture(L"ButtonBottom_Seclect", L"Texture\\UI\\Button\\ButtonBottom_Seclect.bmp");
...
void ResourceManager::LoadTexture(const wstring& _key, const wstring& _path)
{
	...
	if (pTex == nullptr)
	{
		cout << "[Error] ResourceManager.cpp LoadTexture (pTex is Null)";
	}
